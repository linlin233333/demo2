	 ...
	 pagination="true" rownumbers="true" url="studentList" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="gradeName" width="250" align="center">学校名称</th>
				<th field="stuDesc" width="250" align="center">学生备注</th>
				<th field="stuContact" width="100" align="center">学生联系方式</th>
				<th field="stuGraduate" width="250" align="center">毕业初中学校</th>
				<th field="stuHSEE" width="100" align="center">是否参加中考</th>
				<th field="stuExNumber" width="200" align="center">中考号</th>
				<th field="stuExSuccess" width="100" align="center">中考成绩</th>
				<th field="major" width="200" align="center">专业方向</th>
				<th field="stuIdCard" width="200" align="center">身份证号</th>
				<th field="stuAddress" width="400" align="center">住址</th>
				<th field="parent" width="100" align="center">家长姓名</th>
				<th field="paContact" width="100" align="center">家长联系方式</th>
				<th field="paOtherContact" width="100" align="center">其他联系方式</th>
				<th field="height" width="100" align="center">身高（cm）</th>
				<th field="weight" width="100" align="center">体重（kg）</th>
				<th field="leftEye" width="100" align="center">左眼视力</th>
				<th field="rightEye" width="100" align="center">右眼视力</th>
				<th field="color" width="100" align="center">辨色</th>
